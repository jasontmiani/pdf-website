...
import { Button, Icon, Flex, Link, ListItem, UnorderedList } from 'react'
            ...
            <nav>
              <Flex alignItems="center">
                <Link href="/" underline={false}>
                  <img
                    alt="PDF Print Communications Logo"
                    src="../static/logos/logo-pdfpc.png"
                    height="60"
                ...
                {!mobile && (
                  <>
                    ...
                    <Box className="nav-links-hide-fouc" paddingX={16}>
                      <Link color="#103c52" href="#" fontSize={17}>
                        Printing
                      </Link>
                    </Box>
                    <Box className="nav-links-hide-fouc" paddingX={16}>
                    ...
                    {/* </Box> */}
                    <Box className="nav-links-hide-fouc" paddingX={16}>
                      <Link color="#103c52" href="#" fontSize={17} target="_blank">
                        Portfolio
                      </Link>
                    </Box>
                  </>
